...
sys.path.insert(0, str(Path(dir_path).parent))
...
def get_avg_data_by_sample(sample_input):
    ...
    print('[get_avg_data_by_sample] Processing SUNRGBD sample ID: %d.' % (i + 1))
...
def save_gt_result(sample_input):
    ...
    bin = gt_config.bins
    print('[save_gt_result] Processing sample ID: %d.' % (i + 1))
    sequence = readsunrgbdframe(sunrgbd_config, image_id=i + 1)
    ...
    with open(save_path, 'wb') as f:
        ...
        print('[save_gt_result] Dumped to %s'%save_path)
