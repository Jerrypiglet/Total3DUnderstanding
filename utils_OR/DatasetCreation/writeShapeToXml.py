...
if __name__ == '__main__':
    ...
    parser.add_argument('--sceneList', default='./forcedFloor.txt', help='the list of scene to be processed')
    ...
    for r in JSONHelper.read(filename_json ):
        ...
        transformFile = osp.join(outdir, 'transform.dat').replace('/xml1/', '/xml/')
